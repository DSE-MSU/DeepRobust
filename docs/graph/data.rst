...
It can be either `"nettack"` or `"gcn"`. If `setting` is `"nettack"`, the data splits are 10%/10%/80%;
if `setting` is `"gcn"`, the data splits will be: 20 nodes per class for training, 
